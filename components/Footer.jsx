        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                href={`https://api.whatsapp.com/send?text=Check%20out%20BlogVerse%20-%20A%20free%20community%20blogging%20platform!%20${process.env.NEXT_PUBLIC_SITE_URL || 'https://blogverse.pages.dev'}`}
                target="_blank"
              ...
              <a
                href={`https://twitter.com/intent/tweet?text=Check%20out%20BlogVerse%20-%20A%20free%20community%20blogging%20platform!&url=${process.env.NEXT_PUBLIC_SITE_URL || 'https://blogverse.pages.dev'}`}
                target="_blank"
                rel="noopener noreferrer"
